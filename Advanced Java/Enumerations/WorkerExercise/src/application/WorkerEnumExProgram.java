...
import entities.HourContractEnumEx;
import entities.WorkerEnumEx;
...
public class WorkerEnumExProgram {
    public static void main(String[] args) throws ParseException {
        ...
        WorkerEnumEx worker = new WorkerEnumEx(name, WorkerLevelEnumEx.valueOf(level), baseSalary);
        ...
        for (int i = 0; i < contracts; i++) {
            ...
            worker.addContract(new HourContractEnumEx(contractDate, valuePerHour, duration));
            sc.nextLine();
        }
